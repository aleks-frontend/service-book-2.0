...
const PdfInvoice = (props) => {
    ...
    const entityTotalCalculation = (entityName) => {
        const emptyCheck = service[entityName] === '' || service[entityName] === [];
        return emptyCheck ? 0 : service[entityName].reduce((total, entity) => {
        ...
        if (service[entityName] !== []) {
            const getLabel = (entity) => {
                if (entityName === 'actions') {
                    ...
                    const deviceSerial = entity.serial;
            ...
            return service[entityName].map((entity, index) => (
            ...
            <Page style={styles.page}>
                <View style={styles.header}>
                    <View style={styles.headerText}>
                        <Text style={styles.headerTitle}>Invoice No: {props.service.id}</Text>
